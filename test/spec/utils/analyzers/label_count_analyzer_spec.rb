  ...
  describe '#analyze' do
    ...
    it 'returns hash of users' do
      raw = '{"id":"52d01ea35592096d7e24fd0f",' +
            '"labelNames":{"yellow":"Spring","red":"Summer","purple":"Fall","orange":"Winter","green":"Anytime","blue":"Nice-To-Haves"},' +
            ...
            '{"id":"52d01fb64b46b82f5686b091","labels":[{"color":"purple","name":"Fall"},{"color":"yellow","name":"Spring"},{"color":"orange","name":"Winter"}]},' +
      ...
      expect(LabelCountAnalyzer.analyze(raw)).to match({
        labels: ["Spring", "Winter", "Summer", "Anytime", "Fall", "Nice-To-Haves"],
        counts: [4, 2, 2, 1, 1, 0],
